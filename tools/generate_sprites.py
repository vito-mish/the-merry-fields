...
E = ( 40, 25, 12,255)  # eye (dark)
G = (255,255,255,255)  # eye glint (white highlight)
...
HEAD_DOWN = [
    ...
    [_,_,_,H,S,E,E,S,S,E,E,S,H,_,_,_],  # 2px wide eyes
    [_,_,_,H,S,E,G,S,S,E,G,S,H,_,_,_],  # eye + glint
    [_,_,_,H,S,S,S,S,S,S,S,S,H,_,_,_],
...
HEAD_RIGHT = [
    ...
    [_,_,_,_,H,S,E,E,S,S,S,H,_,_,_,_],  # 2px wide eye
    [_,_,_,_,H,S,E,G,S,S,S,H,S,_,_,_],  # eye + glint + ear
    [_,_,_,_,H,S,S,S,S,S,S,H,_,_,_,_],
